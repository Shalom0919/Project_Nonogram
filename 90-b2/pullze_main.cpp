    ...
    while (true) {
        ...
        switch (choice) {
            ...
            case 5:
                ...
                break;
            case 9:
                draw_fake_GUI(game, true, false, 9);
                draw_game_area(game, 9);
                break;
            ...
            case 6:
                ...
                break;
            case 10:
                draw_fake_GUI(game, true, false, 10);
                draw_game_area(game, 10);
            ...
            case 7:
                ...
                break;
            case 11:
                draw_fake_GUI(game, false, false, 11);
                loop_BIG(game);
                break;
        }
